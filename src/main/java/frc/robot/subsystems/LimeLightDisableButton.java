 ...
 */
public class LimeLightDisableButton extends Button {

    private InputSubsystem inputSubsystem;

    public LimeLightDisableButton(InputSubsystem inputSubsystem) {
    ...
    @Override
    public boolean get() {
        return this.inputSubsystem.getLimeLightDisableButton();
    }
}
