 ...
 */
public class LimeLightEnableButton extends Button {

    private InputSubsystem inputSubsystem;

    public LimeLightEnableButton(InputSubsystem inputSubsystem) {
    ...
    @Override
    public boolean get() {
        return this.inputSubsystem.getLimeLightEnableButton();
    }
}
